...
function getProposalOutcome(proposal) {
  const yesVotes = Number(proposal.yesVotes);
  const noVotes = Number(proposal.noVotes);

  if (yesVotes === noVotes) return "Teng ovoz";
  return yesVotes > noVotes ? "Yes ustun" : "No ustun";
}
  ...
  return (
    <div className="app-shell">
      ...
      <header className="hero">
        <div>
          <p className="eyebrow">Jahongir Web3 Studio</p>
          <h1>NFT + Community Hub</h1>
          <p className="hero-copy">
            Jahongir uchun tayyorlangan bu interfeys mint, metadata boshqaruvi va hamjamiyat voting oqimini bitta Web3 panelga jamlaydi.
          </p>
        </div>
              ...
              proposals.map((proposal) => {
                ...
                return (
                  <article className="proposal-card" key={proposal.id}>
                    ...
                    <small>Holat: {getProposalOutcome(proposal)}</small>
